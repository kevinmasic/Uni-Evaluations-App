...
class QuadGeometry extends Geometry {
  constructor(size = 1) {
    super();
    const s = size;
    this.addVertex(-s, -s, 0, s, -s, 0, s, s, 0, -s, s, 0);
    ...
    this.vertices.forEach((vertex, index) => {
      vertex.uv[0] = uvs[index][0];
      vertex.uv[1] = uvs[index][1];
    });
...
class InfiniteGridMenu {
  ...
  #animate(deltaTime) {
    ...
    positions.forEach((p, ndx) => {
      ...
      mat4.multiply(matrix, matrix, mat4.fromScaling(mat4.create(), [finalScale * posterAspect, finalScale, finalScale]));
    ...
    <div className="infinite-menu">
      ...
      {activeItem && (
        <>
          ...
          <div onClick={handleButtonClick} className="action-button active">
